...
case "${site_version}" in
    19.4.0|19.3.3|19.3.2|19.2.4)
      java_ver="1.8.0_231";
      ;;
    19.2.5|19.3.4|19.4.1|19.4.2|19.4.3|20.1.0|20.1.1)
      java_ver="1.8.0_241";
      ;;
    19.4.4|20.1.2|20.1.3|20.2.0|20.2.1|20.2.2|20.3.0|20.3.1)
      java_ver="1.8.0_251";
      ;;
    19.4.5|20.1.4|20.2.3|20.3.2|20.3.3)
      java_ver="1.8.0_261";
      ;;
    19.4.6|20.1.5|20.2.4|20.3.4|20.3.5|20.3.6|21.1.0|21.1.1|21.1.2|21.1.3)
      java_ver="1.8.0_271";
      ;;
    20.2.5|20.3.8|21.1.4|21.1.5|21.1.6|21.1.7|21.1.8|21.2.0|21.2.1|21.2.2)
      java_ver="1.8.0_281";
      ;;
esac
...
ssh ${sshOpts} -t -t ${tHost} "
                              ...
                              sudo sed -i 's/provadmin-dc3.app.mgt.dc3.bmi/provadmin.app.mgt.ch3.bmi/g' /bigmac/install/constants_override;
                              sudo sed -i 's/provadmin-dc3.app.mgt.dc3.bmi/provadmin.app.mgt.ch3.bmi/g' /bigmac/install/container_history;
                              sudo sed -i 's/provadmin-dc3.app.mgt.dc3.bmi/provadmin.app.mgt.ch3.bmi/g' /bigmac/container-setup/weave;
                              "
#
#   Set up weave
#
